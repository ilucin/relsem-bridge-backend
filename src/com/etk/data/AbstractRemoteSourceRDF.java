...
public abstract class AbstractRemoteSourceRDF implements DataSource{
	protected String service;
	protected String queryStringTemplate;
	protected String defaultDataSetName;
	
	// The variable that is used in the query inside of getEntityCandidates
	// in classes that extend this.
	protected final String entityVariable = "entityCandidate";
	
	public AbstractRemoteSourceRDF( String service, String defaultDataSetName ){
	...
	protected List<Object> entityCandidatesFromRS(ResultSet resultSet){
		List<Object> entityCandidates = new ArrayList<Object>();
		
		QuerySolution qs;
		while( resultSet.hasNext() ){
 			qs = resultSet.next();
			entityCandidates.add( new EntityCandidate(qs.get(entityVariable).toString()) );
		}
	...
	public List<String> getAvailableEndpoints(){
		...
		availableEndpoints.add("http://dbpedia.org/sparql");
